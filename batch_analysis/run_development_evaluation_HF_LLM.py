...
for project in os.listdir(base_dir):
    ...
    for i in range(1, len(keys)):
        ...
        # FORMATTING
        general_error_message = dict(iter_numeric_kv(general_error_message)) 
        special_error_message = dict(iter_numeric_kv(special_error_message)) 
        ...
        while counter > 0:
            ...
            """
            MAKE SURE THERE ARE NO DUPLICATE CODE
                            MAKE SURE THE CODE IS MAINTANABLE
                            LOW CYCLOMATIC COMPLEXITY


            ADD DETAILED COMMENTS () -> Higher score is better
                PUT CODE INSIDE A MULTIPLE FUNCTIONS FOR MAINTAINABILITY () Higher score is better
                MAKE SURE THERE ARE NO DUPLICATE CODE () Lower score is better
                MAKE SURE THE CODE IS MAINTANABLE () Higher score is better
                LOW CYCLOMATIC COMPLEXITY () Medium score (6-10 or 11-20) is better                
            """
